        ...
        switch(state_) {
            case SNAPSHOT_MENU_OPTIONS:
                if(storage.GetSnapshot(snapshot_)->factory_preset)
                {
                    ...
                    setOptionSelected(CLAMP<int8_t>(option_selected_ - 1, SNAPSHOT_MENU_SAVE, SNAPSHOT_MENU_DELETE));
            ...
            case SNAPSHOT_MENU_NONE:
                snapshot_ = CLAMP<int16_t>(snapshot_ - 1, 0, USER_SNAPSHOT_COUNT - 1);
            ...
            case SNAPSHOT_MENU_CONFIRM:
                setOptionSelected(CLAMP<int8_t>(option_selected_ - 1, SNAPSHOT_MENU_NO, SNAPSHOT_MENU_YES));
                break;
            default:
                break;
        }
